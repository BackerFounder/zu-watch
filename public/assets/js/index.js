...
$ ('.index-action').on ('mouseover', '[data-hover-show]', function () {
  ...
  $ ('.build-bg').css (
    'background-image',
    "url('https://s3cdn.backer-founder.com/lp/zuwatch/img/main/bg/" +
      h +
      ".jpg')"
  );
});
...
// collection
$ ('#go-to-collection-btn').on ('click', function () {
  $ ('#collection').fadeIn (300);
});

$ ('#collection').on ('click', '.back-to-customize', function () {
  $ ('#collection').fadeOut (300);
});

// collection detail
$ ('#collection').on ('click', '[data-details]', function () {
  var t = $ (this).attr ('data-details');
  $ ('#collection-detail').fadeIn (300);
  $ ('#collection-detail .collection-detail-content').hide ();
  $ (
    '#collection-detail .collection-detail-content[data-details="' + t + '"]'
  ).show ();
});
$ ('#collection-detail').on ('click', '.back-to-collection', function () {
  $ ('#collection-detail').fadeOut (300);
});
...
// mobile
// add to cart
$ ('body').on ('click', '.seecart-btn, .add-this-btn, #addtocart, #checkcart', function () {
...
$ (
  ...
  'click',
  '#recommend-back, .recommend-style, .preview-show-body',
  function () {
...
$ (
  ...
  'click',
  '.mockup-btns .mockup-btn, #mobile-tools .mockup-btn',
  function () {
...
if ($ (window).width () <= 850) {
  $ ('.wrap .mockup-man').attr (
    'src',
    'https://s3cdn.backer-founder.com/lp/zuwatch/img/main-mobile/mockup/man.png'
  );
  $ ('.wrap .mockup-woman').attr (
    'src',
    'https://s3cdn.backer-founder.com/lp/zuwatch/img/main-mobile/mockup/woman.png'
  );
} else {
  $ ('.wrap .mockup-man').attr (
    'src',
    'https://s3cdn.backer-founder.com/lp/zuwatch/img/main/mockup/man.png'
  );
  $ ('.wrap .mockup-woman').attr (
    'src',
    'https://s3cdn.backer-founder.com/lp/zuwatch/img/main/mockup/woman.png'
  );
}
